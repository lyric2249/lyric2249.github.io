...
```{r knitr-logo, out.width='32.8%', fig.show='hold', fig.cap='Goodness-of-fit Plots, for ERGMs - for the high school student friendship network'}
knitr::include_graphics('pics/survival/06/01.png')
```
