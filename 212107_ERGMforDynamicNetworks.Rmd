...
3. **Reciprocity**	: t-1 시점에 i에서 j로 향하는 link가 있었다면 t 시점에 j에서 i로 향하는 링크가 생겨날 경향
4. **Transitivity**	: t-1 시점에 i에서 j, j에서 k로 향하는 tie가 존재한다면 t 시점에 i에서 k로의 tie가 생겨나는 것으로 이어지는 경향
