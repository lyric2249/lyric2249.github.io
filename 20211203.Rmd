...
-> Network Statistics $S(y)$ capture characteristics of network
-> plug-in network statistics with their corresponding prameteres into the exponential term $\exp \Big (\sum_{i=1}^p \theta_i S_i(y) \Big )$, which is unnormalized density
...
1. Uniform homophily effects.

$$
h(x_i , x_j) = \cases{1 & \( x_i = x_j\) \\ 0 & o.w.}
$$

2. Differential homophily effects.
