...
```{r knitr-logo, out.width='32.8%', fig.show='hold', fig.cap='Basic Markov Network Statistics'}
...
```{r knitr-logo, out.width='32.8%', fig.show='hold', fig.cap='Degree and Shared Partnership Distribution'}
knitr::include_graphics('images/knit-logo.png')
```
...
```{r knitr-logo, out.width='32.8%', fig.show='hold', fig.cap='Model Degeneracy for Basic Markov Statistics, Figure: Visualization of the degeneracy (black) and non-degeneracy (white) region of an ERGM with edge counts and K2-star.'}
